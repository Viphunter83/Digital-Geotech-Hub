...
def seed_static(client):
    ...
    # Hero configs
    hero_configs = [
        {"id": "spb", "title": "Terra Expert — СПб", "usp": "Нулевой цикл в условиях исторической застройки Санкт-Петербурга. 15+ лет опыта и деликатное погружение шпунта (Silent Piler).", "cta_text": "Рассчитать смету для СПб"},
        {"id": "msk", "title": "Terra Expert — МСК", "usp": "Оперативная перебазировка тяжелой техники в Москву и МО. Лидерное бурение и устройство свайных полей в рекордные сроки.", "cta_text": "Рассчитать смету для МСК"},
    ]
...
def main():
    print("🚀 Terra Expert — CMS Seed Script")
    print("=" * 50)
