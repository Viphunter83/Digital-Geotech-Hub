...
const services = [
    {
        title: "Нулевой цикл",
        description: "Полный комплекс работ по подготовке основания, земляные работы и устройство фундаментов.",
        icon: <Ruler className="w-8 h-8" />,
        stats: "15+ лет опыта"
    },
    {
        title: "Шпунтовые работы",
        description: "Устройство шпунтовых ограждений любой сложности с применением вибропогружателей.",
        icon: <Hammer className="w-8 h-8" />,
        stats: "24/7 поддержка"
    },
    {
        title: "Аренда техники",
        description: "Собственный парк тяжелой спецтехники. Доставка на объект в течение 24 часов.",
        icon: <Truck className="w-8 h-8" />,
        stats: "50+ единиц"
    },
    {
        title: "Проектирование",
        description: "Разработка технической документации и расчет устойчивости конструкций.",
        icon: <ShieldCheck className="w-8 h-8" />,
        stats: "AI-оптимизация"
    }
];
